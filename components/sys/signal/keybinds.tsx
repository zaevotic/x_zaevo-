...
export default function KeybindsPanel() {
  ...
  return (
    <div className="flex flex-col h-full w-full">
      <p className="text-[9px] tracking-[.1em] text-[var(--text3)] mb-[10px]">ACTIVE BINDINGS</p>
      <div className="flex flex-col gap-[5px]">
        {binds.map((bind, idx) => (
          <div key={idx} className="flex justify-between items-center text-[10px] bg-[var(--bg2)] border border-[var(--border)] rounded-[2px] px-[8px] py-[5px]">
